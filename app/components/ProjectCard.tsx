...
export default function ProjectCard({
  ...
  useEffect(() => {
    ...
    // skip preload on mobile to save bandwidth
  ...
  return (
    ...
    >
      ...
      {video ? (
        <div
          className="relative bg-black overflow-hidden border-b-4 border-text-dark shrink-0 cursor-pointer"
          style={{ height: '200px' }}
          onClick={handleTap}
        >
          ...
          />
          {/* play overlay — visible only when poster is shown (video stopped) */}
          {showPoster && (
            <div className="absolute inset-0 z-[2] flex items-center justify-center bg-black/20 opacity-0 hover:opacity-100 transition-opacity duration-200 sm:hidden">
